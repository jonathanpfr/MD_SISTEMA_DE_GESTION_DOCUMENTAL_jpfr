...
import { IProductSearchItem, IPagination, ISupplierSearchRequest } from '@dispatch-commons/interfaces';
...
export class SupplierProductsComponent implements OnInit, AfterViewInit {
  ...
  loadData(request: ISupplierSearchRequest): void {
    ...
    this.supplierService.getProducts(request)
      .pipe(
  ...
  edit(element: IProductSearchItem): void {
    this.router.navigateByUrl(`/proveedor/registro/${element.idProveedor}`);
  }

  delete(item: IProductSearchItem): void {
