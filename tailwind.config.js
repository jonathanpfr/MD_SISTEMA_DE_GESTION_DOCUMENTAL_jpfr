...
const config = {
    ...
    plugins: [
        ...
        require(path.resolve(__dirname, ('libs/@fuse/tailwind/plugins/utilities'))),
        require(path.resolve(__dirname, ('libs/@fuse/tailwind/plugins/icon-size'))),
        require(path.resolve(__dirname, ('libs/@fuse/tailwind/plugins/theming')))({ themes }),
